...
if st.session_state.user_data is None:
    ...
    st.markdown(f"""
        <div class="user-card">
            ...
            <div style="color:#6c757d; font-weight:bold;">⏱️ {t_min} min activo</div>
        </div>
    """, unsafe_allow_html=True)
    ...
    # 6. Botón X Flotante (Inferior Izquierda)
    st.markdown('<a href="/" target="_self" id="btn-exit-flotante"></a>', unsafe_allow_html=True)